...
static uint8_t SD_ReadyWait(void)
{
    ...
    bc_log_debug("SD_readywait Timer2 %d", Timer2);
...
static void SD_PowerOn(void)
{
    ...
    bc_log_debug("Poweron cnt: %d", cnt);
